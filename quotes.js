...
function changequote() {
    ...
    if (i < quotes.length) {
        var currentObj = quotes[i];
        var quotetext = document.getElementById("quote-text");
        var quotespeaker = document.getElementById("quote-speaker");
        var quoteurl = document.getElementById("quote-url");
        var quotedate = document.getElementById("quote-date");

        quoteurl.href = currentObj.url;
        quotetext.innerHTML = currentObj.text;
        quotespeaker.innerHTML = currentObj.speaker;
        quotedate.innerHTML = currentObj.date;
        i++;
    } else {
        i = 0;
    }
